...
export function CursorDashboard() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#030406] text-zinc-100">
      <div
      ...
      />
      <div className="pointer-events-none absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%2780%27 height=%2780%27 viewBox=%270 0 80 80%27%3E%3Cg fill=%27none%27 stroke=%27rgba(255,255,255,0.03)%27 stroke-width=%271%27%3E%3Cpath d=%27M0 40h80M40 0v80%27/%3E%3C/g%3E%3C/svg%3E')] opacity-40" />
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1400px] flex-col gap-6 px-4 py-8 sm:px-6 lg:px-10">
        <header className="flex flex-col gap-2 border-b border-white/10 pb-6 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="font-mono text-[11px] uppercase tracking-[0.28em] text-cyan-300/80">Live telemetry</p>
          ...
          <div className="rounded-xl border border-white/10 bg-white/[0.03] px-4 py-2 font-mono text-[11px] text-zinc-400">
